...
<body>
    ...
    <div class="container-col">
        ...
        <div class="team-col">
            <img src="assets/img-about/Jason.jpg"  alt="">
            <div class="name-col">Jason Piit</div>
            <div class="design">Developer</div>
            <div class="about-col">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do 
                eiusmod tempor incididunt ut labore et dolore magna aliqua.</div>

            <button type="button" class="btn">Let's Talk</button>
        </div>
        <div class="team-col">
            <img src="assets/img-about/Aillen.jpg"  alt="">
            <div class="name-col">Aillen Gonzaga</div>
